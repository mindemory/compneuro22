...
class Model(object):
    ...
    """
    def __init__(self, datafile='subgraph_data.pkl', seed = 0, macroGradient = True, ext_params={}):
        #---------------------------------------------------------------------------------
        ...
        p['hier_avg'] = np.mean(p['hier_vals']) # Computing average hierarchy
        ...
        if macroGradient:
            ...
            p['exc_scale'] = (1+p['eta']*p['hier_avg'])
